{
  ...
  programs.fish = {
    ...
    functions = {
      ...
      import-paypal.body = "scp $argv root@nix02:/var/lib/paypal-import/inbox/; and rm $argv";
      import-bank.body = "scp $argv root@nix02:/var/lib/bank-import/inbox/; and rm $argv";
    };
  };
