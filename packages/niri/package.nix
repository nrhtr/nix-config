...
rustPlatform.buildRustPackage (finalAttrs: {
  pname = "niri";
  #version = "25.08-axelkar";
  version = "25.08";

  src = fetchFromGitHub {
    # Add support for remote desktop portal
    owner = "axelkar";
    repo = "niri";
    rev = "fb27849";
  ...
  cargoHash = "sha256-gv87edvnN/j49Zy7bz7oQoj2xN01zLZ7WwjfjaHoOx4=";
  ...
  buildFeatures =
    ...
    ++ ["xdp-gnome-remote-desktop" "xdp-gnome-input-capture"];
  ...
  # Fails w/ remote desktop patches
  doCheck = false;
